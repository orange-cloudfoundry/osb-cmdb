...
abstract class CloudFoundryAcceptanceTest {
	...
	private List<String> getAppBrokerProperties(BrokerProperties brokerProperties) {
		String[] openServiceBrokerProperties = {
			...
			"spring.cloud.openservicebroker.catalog.services[0].plans[0].plan_updateable=true",
			"spring.cloud.openservicebroker.catalog.services[0].plans[0].allow_context_updates=true",
			...
			"spring.cloud.openservicebroker.catalog.services[0].plans[1].allow_context_updates=true",
			"spring.cloud.openservicebroker.catalog.services[0].plans[1].plan_updateable=true",
