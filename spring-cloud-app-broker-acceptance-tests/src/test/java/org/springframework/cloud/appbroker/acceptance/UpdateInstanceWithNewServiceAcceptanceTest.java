...
class UpdateInstanceWithNewServiceAcceptanceTest extends CloudFoundryAcceptanceTest {
	...
	void weCreateAService() {
		...
		ServiceInstance backingServiceInstance = null;//getBackingServiceInstance(OLD_BACKING_SI_NAME);
	...
	void weUpdateTheServiceInstanceWithANewBackingService() {
		...
		ServiceInstance newBackingServiceInstance = null;//getBackingServiceInstance(NEW_BACKING_SI_NAME);
