...
public class CloudFoundryDeploymentProperties extends DeploymentProperties {
	 ...
	 */
	public static final String HEALTHCHECK_PROPERTY_KEY = "health-check";

	/**
	 * Key for storing the health check endpoint deployment property
	 */
	public static final String HEALTHCHECK_HTTP_ENDPOINT_PROPERTY_KEY = "health-check-http-endpoint";

	/**
	 * Key for storing the health check timeout deployment property
	 */
	public static final String HEALTHCHECK_TIMEOUT_PROPERTY_KEY = "health-check-timeout";

	/**
	 * Key for storing the route path deployment property
	 */
	public static final String ROUTE_PATH_PROPERTY = "route-path";
	 ...
	 */
	public static final String ROUTES_PROPERTY = "routes";

	/**
	 * Key for storing a property describing whether routes are defined
	 */
	public static final String NO_ROUTE_PROPERTY = "no-route";
	 ...
	 */
	public static final String BUILDPACK_PROPERTY_KEY = "buildpack";

	/**
	 * Key for storing JAVA_OPTS deployment property
	 */
	public static final String JAVA_OPTS_PROPERTY_KEY = "javaOpts";
