...
public class CloudFoundryAppDeployerTest {
	...
	@Test
	public void deployAppWithPlatformDefaults() {
	...
	@Test
	public void deployAppWithPropertiesInRequest() {
		DeployApplicationRequest request = DeployApplicationRequest.builder()
			.name(APP_NAME)
			.path(APP_PATH)
			.serviceInstanceId(SERVICE_INSTANCE_ID)
	...
	@Test
	public void deployAppWithDefaultProperties() {
	...
	@Test
	public void deployAppWithRequestOverridingDefaultProperties() {
		deploymentProperties.setCount(3);
		deploymentProperties.setMemory("2G");
		deploymentProperties.setDisk("3G");
	...
	@Test
	public void deployAppWithBothDomainAndDomainsProperties() {
		deploymentProperties.setCount(3);
		deploymentProperties.setMemory("2G");
		deploymentProperties.setDisk("3G");
		deploymentProperties.setBuildpack("buildpack1");
	...
	@Test
	public void deployAppWithEnvironmentUsingSpringAppJson() {
	...
	@Test
	public void deployAppWithEnvironmentNotUsingSpringAppJson() {
	...
	@Test
	public void deployAppWithStartOption() {
		DeployApplicationRequest request = DeployApplicationRequest.builder()
			.name(APP_NAME)
			.path(APP_PATH)
	...
	@Test
	public void deployAppWithStartTrueByDefault() {
		DeployApplicationRequest request = DeployApplicationRequest.builder()
			.name(APP_NAME)
			.path(APP_PATH)
			.serviceInstanceId(SERVICE_INSTANCE_ID)
	...
	@Test
	public void deleteServiceInstanceShouldUnbindServices() {
	...
	@Test
	public void deleteServiceInstanceWithTarget() {
		given(operationsServices.deleteInstance(
			org.cloudfoundry.operations.services.DeleteServiceInstanceRequest.builder()
				.name("service-instance-name")
				.build()))
	...
	@Test
	public void createServiceInstanceWithTarget() {
		given(operationsOrganizations
			.get(
				OrganizationInfoRequest
					.builder()
	...
	@Test
	public void updateServiceInstanceUpdatesWithParameters() {
	...
	@Test
	public void updateServiceInstanceRebindsWhenRequired() {
		given(operationsServices.updateInstance(
			org.cloudfoundry.operations.services.UpdateServiceInstanceRequest.builder()
				.serviceInstanceName("service-instance-name")
				.parameters(emptyMap())
	...
	@Test
	public void updateServiceInstanceDoesNothingWithoutParameters() {
		given(operationsServices.updateInstance(
			org.cloudfoundry.operations.services.UpdateServiceInstanceRequest.builder()
				.serviceInstanceName("service-instance-name")
				.parameters(emptyMap())
	...
	@Test
	public void getServiceInstanceById() {
	...
	@Test
	public void getServiceInstanceByName() {
		given(operationsServices.getInstance(any(GetServiceInstanceRequest.class)))
			.willReturn(Mono.just(ServiceInstance.builder()
				.id("foo-service-instance-id")
				.name("my-foo-service")
	...
	@Test
	public void getServiceInstanceByNameAndSpace() {
		given(operationsServices.getInstance(any(GetServiceInstanceRequest.class)))
			.willReturn(Mono.just(ServiceInstance.builder()
				.id("foo-service-instance-id")
				.name("my-foo-service")
