...
public class CloudFoundryAppDeployerUpdateApplicationTest {
	...
	@Test
	public void updateAppWithUpgrade() {
		Map<String, String> properties = new HashMap<>();
	...
	@Test
	public void updateAppWithHostAndDomain() {
		given(applicationsV2.update(any()))
			.willReturn(Mono.just(UpdateApplicationResponse.builder()
				.build()));
	...
	@Test
	public void updateAppWithHostAndMergedDomains() {
		given(applicationsV2.update(any()))
			.willReturn(Mono.just(UpdateApplicationResponse.builder()
				.build()));
	...
	@Test
	public void updateAppWithHostAndDomains() {
		given(applicationsV2.update(any()))
			.willReturn(Mono.just(UpdateApplicationResponse.builder()
				.build()));
	...
	@Test
	public void updateAppWithHostAndNoDomain() {
		given(applicationsV2.update(any()))
			.willReturn(Mono.just(UpdateApplicationResponse.builder()
				.build()));
	...
	@Test
	public void updateAppWithDomainAndNoHost() {
		given(applicationsV2.update(any()))
	...
	@Test
	public void updateAppWithNotExistingDomain() {
		given(applicationsV2.update(any()))
			.willReturn(Mono.just(UpdateApplicationResponse.builder()
				.build()));
