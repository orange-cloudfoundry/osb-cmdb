...
public class DeployerClientTest {
	...
	public void shouldDeployAppWithProperties() {
		setupAppDeployer();
	...
	@Test
	@SuppressWarnings("serial")
	public void shouldDeployAppWithService() {
		setupAppDeployer();
	...
	@Test
	@SuppressWarnings("serial")
	public void shouldDeployAppWithEnvironmentVariables() {
		setupAppDeployer();
	...
	@Test
	public void shouldNotReturnErrorWhenUndeployingAppThatDoesNotExist() {
		given(appDeployer.undeploy(any()))
	...
	@Test
	public void shouldCreateServiceInstance() {
	...
	@Test
	public void shouldReturnErrorWhenUpdatingServiceInstanceThatDoesNotExist() {
		given(appDeployer.updateServiceInstance(any()))
	...
	@Test
	public void shouldNotReturnErrorWhenDeletingServiceInstanceThatDoesNotExist() {
		given(appDeployer.deleteServiceInstance(any()))
			.willReturn(Mono.error(new IllegalStateException("service instance does not exist")));
