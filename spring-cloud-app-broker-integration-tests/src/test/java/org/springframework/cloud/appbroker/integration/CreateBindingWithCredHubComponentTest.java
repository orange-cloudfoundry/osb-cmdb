...
public class CreateBindingWithCredHubComponentTest extends WiremockComponentTest {
	...
	@Test
	public void createAppBindingWithCredHub() {
	...
	@Test
	public void createServiceKeyWithCredHub() {
		String credentialName = credHubFixture.bindingCredentialName(brokerAppName, serviceDefinitionId,
			BINDING_ID, CREDENTIAL_NAME);
