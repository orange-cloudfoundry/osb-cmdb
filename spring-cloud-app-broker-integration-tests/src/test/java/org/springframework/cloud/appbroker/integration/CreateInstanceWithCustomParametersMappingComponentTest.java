...
public class CreateInstanceWithCustomParametersMappingComponentTest extends WiremockComponentTest {
	...
	@Test
	public void pushAppWithParametersTransformedUsingCustomTransformer() {
	...
	protected static class CustomConfig {
		...
		public final class CustomMappingParametersTransformerFactory extends ParametersTransformerFactory<BackingApplication, Object> {
