...
public class DeleteInstanceWithServicesComponentTest extends WiremockComponentTest {
	...
	@Test
	public void deleteAppsAndServicesWhenTheyExist() {
	...
	@Test
	public void deleteAppsWhenTheyExistAndServicesWhenTheyDoNotExist() {
		cloudControllerFixture.stubAppExists(APP_NAME);
		cloudControllerFixture.stubServiceBindingDoesNotExist(APP_NAME);
		cloudControllerFixture.stubDeleteApp(APP_NAME);
	...
	@Test
	public void deleteAppsAndServicesWhenTheyDoNotExist() {
