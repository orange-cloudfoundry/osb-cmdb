...
import  static  com.orange.oss.osbcmdb.integration.CreateInstanceWithBasicAuthCredentialsComponentTest.APP_NAME_1;
import  static  com.orange.oss.osbcmdb.integration.CreateInstanceWithBasicAuthCredentialsComponentTest.APP_NAME_2;
...
class CreateInstanceWithBasicAuthCredentialsComponentTest extends WiremockComponentTest {
	...
	protected static final String APP_NAME_1 = "app-with-credentials1";

	protected static final String APP_NAME_2 = "app-with-credentials2";
	...
	void pushAppWithCredentials() {
		...
		cloudControllerFixture.stubPushApp(APP_NAME_1,
			matchingJsonPath(
				"$.environment_json[?(@.SPRING_APPLICATION_JSON =~ /.*spring.security.user.name.*:.*[a-zA-Z]{14}.*/)]"),
			matchingJsonPath(
				"$.environment_json[?(@.SPRING_APPLICATION_JSON =~ /.*spring.security.user.password.*:.*[a-zA-Z]{14}.*/)]"));
