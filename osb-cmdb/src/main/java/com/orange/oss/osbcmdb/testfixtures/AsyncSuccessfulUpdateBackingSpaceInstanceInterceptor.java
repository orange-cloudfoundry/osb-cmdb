 ...
 */
public class AsyncSuccessfulUpdateBackingSpaceInstanceInterceptor extends BaseServiceInstanceBackingSpaceInstanceInterceptor
	implements ServiceInstanceInterceptor {

	private static final Logger LOG = Loggers.getLogger(AsyncSuccessfulUpdateBackingSpaceInstanceInterceptor.class);

	public AsyncSuccessfulUpdateBackingSpaceInstanceInterceptor(String defaultSpaceName) {
