...
public class ServiceInstanceNameParametersTransformerFactory extends
        ParametersTransformerFactory<BackingService, ServiceInstanceNameParametersTransformerFactory.Config> {

	public ServiceInstanceNameParametersTransformerFactory() {
		super(Config.class);
	}
